...
import { dataportfolio, dataportfolio2025_2026, dataportfolio2026_2027, meta } from "../../content_option";
...
export const Portfolio = () => {
  return (
    ...
    <div className="mb-5 po_items_ho">
      {dataportfolio2026_2027.map((data, i) => {
        return (
          <div key={i} className="po_item">
            <img src={data.img} alt="" />
            <div className="content">
              <p>{data.description}</p>
              <a href={data.link}>placeholder project</a>
            </div>
          </div>
        );
      })}
